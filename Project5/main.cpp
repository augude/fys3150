...
int main(int argc, char* argv[])
{
    if (argc < 11){
        ...
        Solver obj(h, dt, T, xc, sigx, px, yc, sigy, py);
        ...
        if (argc == 11){
            ...
            obj.solve(true, 6e-4, 1 - 0.60, 1 - 0.45);
            if (T > 5e-3){
                obj.states.save("output/" + type + "measure_long_evolution.bin");
            }
            else{
                obj.states.save("output/" + type + "measure_evolution.bin");
            }
        }   
        return 0;
    }
